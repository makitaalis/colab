...
- generated_at_utc: `2026-02-17T21:50:15Z`
...
| `step-16 accessibility acceptance` | `FAIL` | rc=1; RESULT: FAIL |
| `admin smoke gate` | `FAIL` | rc=1 |
...
```text
200
https://127.0.0.1:8443/api/admin/fleet/alerts/groups => RETRY https://127.0.0.1:8443/api/admin/fleet/alerts/groups attempt=1 code=503
200
https://127.0.0.1:8443/api/admin/fleet/incidents => RETRY https://127.0.0.1:8443/api/admin/fleet/incidents attempt=1 code=503
200
https://127.0.0.1:8443/api/admin/fleet/incidents/notifications => RETRY https://127.0.0.1:8443/api/admin/fleet/incidents/notifications attempt=1 code=503
200
https://127.0.0.1:8443/api/admin/fleet/alerts/actions => 200
https://127.0.0.1:8443/api/admin/fleet/notification-settings => RETRY https://127.0.0.1:8443/api/admin/fleet/notification-settings attempt=1 code=503
200
https://127.0.0.1:8443/api/admin/audit => RETRY https://127.0.0.1:8443/api/admin/audit attempt=1 code=503
200
https://127.0.0.1:8443/api/admin/wg/peers => RETRY https://127.0.0.1:8443/api/admin/wg/peers attempt=1 code=503
200
https://127.0.0.1:8443/api/admin/wg/conf => RETRY https://127.0.0.1:8443/api/admin/wg/conf attempt=1 code=503
200
